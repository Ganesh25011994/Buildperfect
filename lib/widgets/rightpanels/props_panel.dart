                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: KeyValueReactiveTextbox(
                      ...
                      onChnage: (FormControl field) {
                      bpWidgetPropsForm.controls['controlName']!.value = widget.props!.controlName;
                      String changeValue = field.value;
                        bpWidgetPropsForm.controls['controlName']!.updateValue('${bpWidgetPropsForm.controls['controlName']!.value}${changeValue.replaceAll(' ', '').toLowerCase()}');
                      },
                    ),
                  ),
                  Padding(
                  ...
                  Padding(
                    ...
                    child: KeyValueReactiveDropdown(
                      ...
                      onSelected: (value) {
                        bpWidgetPropsForm.controls['isVerificationRequired']!.updateValue(value);
                      },
                    ),
                  ),
                  Padding(
                  ...
                  Padding(
                    ...
                    child: KeyValueReactiveDropdown(
                      ...
                      onSelected: (value) {
                        print('type of ${value.runtimeType}');
                        bpWidgetPropsForm.controls['validationPatterns']!.updateValue(value);
                      },
                    ),
                  ),
                  Padding(
